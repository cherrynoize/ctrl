...
-- You can import your theme to derive styles for the
-- widget.
-- If you want to configure other properties in your
-- theme, add them before the fallback option using 'or'.
...
config.border_color = theme.fg_normal or '#87abef' -- Border color.
...
-- Text layout.
config.align    = 'center'
config.font     = theme.font or 'Dejavu Sans Mono 10'

-- Widget colors.
config.fg_color_normal = theme.fg_normal or '#87abef'
config.fg_color_active = theme.green or '#698f1e'
config.fg_color_alert  = theme.red or '#cc2050'
config.fg_color_low    = config.fg_color_discharging
config.fg_color_crit   = config.fg_color_discharging
config.bg_color_active = theme.darkgreen or '#05390d'
config.bg_color_alert  = theme.color_darkred or '#631018'
config.bg_color_low    = config.bg_color_discharging
config.bg_color_crit   = config.bg_color_discharging
...
-- Soundctl config.
config.soundctl_spawn = 'alacritty -e alsamixer' -- Program to spawn on click. 
...
-- 2) Remember paths for custom theme and widgets
--    directory are relative to rc.lua.
-- 3) You may want to edit the backlight path variables
--    to best suit your system.
-- 4) Install `light` and set `use_light` to true in 
